...
class MyNotes {
  ...
  events() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#my-notes").on("click", ".delete-note", this.deleteNote); //whenever youc lick anywhere within the parent unordered list, if the interior element matches .delete-note, then fire off this.deleteNote function.
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#my-notes").on("click", ".edit-note", this.editNote.bind(this)); // We need this to remain the object, not the element that got clicked on in this case.
  ...
  // Custom Methods
  editNote(e) {
    var thisNote = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).parents("li"); // The data attribute of the ID number is in the parent LI element.
  ...
  deleteNote(e) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      //universityData.root_url - this is a property we set up in another lecture. If you view the source code for the front end of the website and search for universityData. It contains the root part of our URL so our code can be flexible here.
...
class Search {
  ...
  constructor() {
    ...
    this.openButton = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".js-search-trigger"); //This is to select the class of js-search-trigger
